...
I am no longer a Ph.D. candidate, I am the real deal in Nuclear Engineering in the [School of Nuclear Science and Engineering](https://ne.oregonstate.edu) at Oregon State University. My major advisor is [Todd Palmer](https://rtrp.github.io/osu-transport/palmerts/). I am also a licensed reactor operator for the [Oregon State TRIGA Reactor](http://radiationcenter.oregonstate.edu/oregon-state-triga-reactor-0) and the Oregon State [ANS & HPS](http://groups.engr.oregonstate.edu/ANS/) vice president.
